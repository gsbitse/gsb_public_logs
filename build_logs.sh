...
sh ${workspace_dir}/logs.sh 5000 > ${workspace_dir}/log_5000_out.html
...
echo '' > log_5000_out.html
echo '' > log_out.html
echo '' > log_1y_out.html
echo '' > log_10_out.html
echo '' > log_1_out.html

git add log_5000_out.html
...
cp ${workspace_dir}/log_5000_out.html gsbitse.github.io/.
